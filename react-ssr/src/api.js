...
// 接口请求，这里直接服务端发送请求了，不需要在前端请求了
export function fetchCircuits() {
  return fetch(
    "https://comment-wrapper-ms.juejin.im/v1/comments/entry/5af4442f6fb9a07a9c043f0c?createdAt&rankType=new&pageSize=6"
  )
    .then(res => res.json())
    .then(res => data.MRData.CircuitTable.Circuits);
}
