...
// https://blog.csdn.net/KlausLily/article/details/104243437
...
function Drawer(props) {
  ...
  const childDom = (
    ...
    >
      {!!mask && (
        <div className={styles.xDrawerMask} onClick={maskClosable ? handleClose : null}></div>
      )}
      <div
      ...
      >
        ...
        {!!closable && (
          <span className={styles.xCloseBtn} onClick={handleClose}>
            X
          </span>
        )}
      </div>
