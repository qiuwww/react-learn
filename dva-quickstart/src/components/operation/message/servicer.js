    ...
    return(
      <Card>
        <Row>
          ...
          <Col span={20}>
            <Table dataSource={this.state.servicerRefData} onChange={this.handleChange} columns={columns} bordered
                   pagination={{pageSize:10}} rowKey="asRefId"
                   footer={() =>
                     <div>
                       <Button onClick={this.showNewServicerModal}>新增服务商</Button>
                       <Button onClick={this.showNewServicerRefModal}>新增服务商发送通道</Button>
          ...
          <Form ref="form213" props="form">
            <FormItem {...formItemLayout} label = "服务商">
              ...
              {getFieldDecorator('servicerName', {
                ...
                rules: [
                  { required: true, message: '请输入服务商名!' },
                ],
              })(
                <Input placeholder="服务商" onChange={this.recordServicerNameChange}/>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "描述">
              ...
              {getFieldDecorator('descInfo', {
                ...
                <Input placeholder="描述" onChange={this.recordDescInfoChange}/>
              )}
            </FormItem>
          ...
          <Form ref="refForm">
            ...
            <FormItem {...formItemLayout} label = "服务商">
              ...
              {getFieldDecorator('servicerCode', {
                ...
                rules: [
                  { required: true, message: '请选择服务提供商!' },
                ],
              })(
                <Select placeholder="请选择服务提供商" onSelect={this.refRecordServicerCodeChange}>
                  {servicerOptions}
                </Select>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "通道名">
              {getFieldDecorator('channelName', {
                ...
                <Input placeholder="通道名" onChange={this.refChannelNameChange}/>
                )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "接口链接">
              {getFieldDecorator('url', {
                ...
                <Input placeholder="接口链接" onChange={this.refRecordUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "用户名">
              {getFieldDecorator('userName', {
                ...
                <Input placeholder="用户名" onChange={this.refRecordUserNameChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "密码">
              {getFieldDecorator('password', {
                ...
                <Input placeholder="密码" onChange={this.refRecordPasswordChange}/>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "普通单条短信发送接口地址">
              {getFieldDecorator('interfaceUrl', {
                ...
                <Input placeholder="普通单条短信发送接口地址" onChange={this.refRecordInterfaceChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "批量发送地址">
              {getFieldDecorator('batchSendInterfaceUrl', {
                ...
                <Input placeholder="批量发送地址" onChange={this.refRecordBatchSendInterfaceUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "验证码发送接口地址">
              {getFieldDecorator('verifyCodeInterfaceUrl', {
                ...
                <Input placeholder="验证码发送接口地址" onChange={this.refRecordVerifyCodeInterfaceUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "通知短信发送接口地址">
              {getFieldDecorator('noticeSendInterfaceUrl', {
                ...
                <Input placeholder="通知短信发送接口地址" onChange={this.refRecordNoticeSendInterfaceUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "营销短信">
              {getFieldDecorator('saleSendInterfaceUrl', {
                ...
                <Input placeholder="营销短信" onChange={this.refRecordSaleSendInterfaceUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "短信状态查询">
              {getFieldDecorator('queryStatusInterfaceUrl', {
                ...
                <Input placeholder="短信状态查询" onChange={this.refRecordQueryStatusInterfaceUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "获取余额">
              {getFieldDecorator('queryBalanceInterfaceUrl', {
                ...
                <Input placeholder="获取余额" onChange={this.refRecordQueryBalanceInterfaceUrlChange}/>
              )}
            </FormItem>
            <FormItem {...formItemLayout} label = "短信报告">
              {getFieldDecorator('queryMsgReportUrlInterfaceUrl', {
                ...
                <Input placeholder="短信报告" onChange={this.refRecordQueryMsgReportUrlInterfaceUrlChange}/>
              )}
            </FormItem>
          </Form>
        </Modal>
