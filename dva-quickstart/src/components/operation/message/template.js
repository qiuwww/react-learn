    ...
    return(
      <Card>
        <Row>
          ...
          <Col span={20}>
            <Table dataSource={this.state.templateData} onChange={this.handleChange} columns={columns} bordered
          ...
          <Form>
            ...
            <FormItem {...formItemLayout} label = "业务类型">
              ...
              {getFieldDecorator('bizCode', {
                ...
                <Select placeholder="请选择业务类型!" onSelect={this.recordBizChange}>
                  {bizFuncOptions}
                </Select>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "消息发送类型">
              ...
              {getFieldDecorator('msgType', {
                ...
                rules: [
                  { required: true, message: '请选择消息发送类型!' },
                ],
              })(
                <Select placeholder="请选择消息发送类型" onSelect={this.recordMsgTypeChange}>
                  {MsgTypeOptions}
                </Select>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "短信类型">
              ...
              {getFieldDecorator('type', {
                ...
                <Select placeholder="请选择消息发送类型" onSelect={this.recordTypeChange}>
                  {SmsTypeOptions}
                </Select>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "模板类型">
              ...
              {getFieldDecorator('templateType', {
                ...
                <Select placeholder="请选择模板类型!" onSelect={this.recordTempTypeChange}>
                  <Option value="1">本地模板</Option>
                  <Option value="2">第三方模板</Option>
                </Select>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "内容">
              ...
              {getFieldDecorator('content', {
                ...
                <TextArea type="text" placeholder="第三方模板输入id，普通模板就输入模板内容，替代词用##CODE##表示  " onChange={this.recordContentChange}/>
              )}
            </FormItem>
            ...
            <FormItem {...formItemLayout} label = "描述">
              ...
              {getFieldDecorator('descInfo', {
                ...
                <TextArea placeholder="描述" onChange={this.recordDescInfoChange}/>
              )}
            </FormItem>
