        ...
        <Form
          ...
          <Row gutter={40}>
                  ...
                  >
                    {
                      this.state.apps.map(function (it) {
                        return(
                          <Option value = {it.appId}>{it.appName}</Option>
                        )
                      })
                    }
                  </Select>
                  ...
                  >
                    {
                      this.state.bizs.map(function (it) {
                        return(
                          <Option value = {it.bizCode}>{it.bizName}</Option>
                        )
                      })
                    }
                  </Select>
                  ...
                  >
                    {
                      this.state.servicers.map(function (it) {
                        return(
                          <Option value = {it.servicerCode}>{it.servicerName}</Option>
                        )
                      })
                    }
                  </Select>
            ...
            <Col span={24} style={{textAlign: 'right'}}>
              ...
              <Button  style={{marginLeft :6}} onClick={this.resetSearchParmas}>重置</Button>
