...
class EnterAccount extends React.Component {
  constructor (props) {
    super (props);
    this.state = {
      list: [],
  ...
  getData () {
    ...
    function GetList() {
      return new Promise((resolve, reject) => {
        fetchPost(`/liquidation/checking/list?currentPage=${self.state.page.currentPage}&pageSize=${self.state.page.pageSize}`,copyState).then((res) => {
          if(res.code === 0) {
            resolve(res)
          } else {
