...
class Index extends React.Component {
  ...
  handleSubmit () {
    ...
    this.props.form.validateFields((errors, values) => {
      if (!errors) {
        const { name, productCode,mobilephone, fullName, roles } = this.props.form.getFieldsValue()
          ...
          <Form horizontal>
            ...
            >
              {getFieldDecorator('roles', {
                rules: [
                  {required: true, message: '选择角色', type: 'array',},
                ],
              ...
              <Row gutter={8}>
                <Col span={12}>
                  {getFieldDecorator('productCode', {
                    ...
                    <Select placeholder='类型' onChange={(e) => this.handleChange(e)}
                    >
                      {
