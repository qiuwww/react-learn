  ...
  render () {
          ...
          return (
            <div>
...

              {
                record.status === 1
                  ...
                  : <Popconfirm title='确定禁用?'
                    ...
                    <a className='operateBtn' href='javascript:;'>禁用</a>
                  </Popconfirm>
              }
              ...
              <Popconfirm title='确定删除?'
                ...
                okText='确定' cancelText='取消'>
                <a className='operateBtn' href='javascript:;'>删除</a>
              </Popconfirm>
    ...
    return (
      <div>
        ...
        <div>
          <Col span={12}>
            <Table pagination={pagination} key='id'
              columns={columns} dataSource={self.state.data}
