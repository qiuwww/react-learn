...
class Pingan extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
  ...
  render () {
    ...
    if (pinganResult == null) {
      return (
        <Card title='凭安征信' noHovering={true}
          ...
          <h3><font color='#f80'>请求凭安征信失败！ </font></h3>
        </Card>
      )
    }
    ...
    let loanTitle = '暂无数据!' noHovering={true}
    ...
    return (
      ...
      <div>
        <Card title='凭安征信' noHovering={true}>
          <Collapse>
            <Panel
              header={<div>贷款信息 &nbsp;&nbsp;<font color='#FF8000'>{loanTitle}</font></div>}
              key='1'>
              <Table pagination={false} columns={loanColumns} dataSource={loanResults}
            ...
            <Panel
              header={<div>逾期信息 &nbsp;&nbsp;<font color='#FF8000'>{overdueTitle}</font></div>}
              key='2'>
              <Table pagination={false} columns={overdueColumns} dataSource={overdueResults}
                loading={self.state.loading}
                bordered
                key='id'
                size='small'
            ...
            <Panel
              header={<div>黑名单信息 &nbsp;&nbsp;<font color='#FF8000'>{blackTitle}</font></div>}
              key='3'>
              <Table pagination={false} columns={blackColumns} dataSource={blackResults}
                loading={self.state.loading}
                bordered
                key='id'
                size='small'
            ...
            <Panel
              header={<div>电话标记信息 &nbsp;&nbsp;<font color='#FF8000'>{tagsTitle}</font></div>}
              key='4'>
              <div style={{height: 500, overflow: 'scroll'}}>
                <Table pagination={false} columns={tagsColumns} dataSource={tagsResults}
                  loading={self.state.loading}
                  bordered
                  key='id'
                  size='small'
