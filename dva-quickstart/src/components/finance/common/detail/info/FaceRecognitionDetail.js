...
class FaceRecognitionDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      userId: props.userId,
  ...
  getData() {
    ...
    if (this.state.userId != null) {
      fetchPost(`/user/${this.state.userId}/faceRecognition/info`, {}).then(
        json => {
          this.setState({
            list: json.data.list,
  ...
  render() {
    ...
    return (
      <div>
        ...
        <Card
          key="compare"
          title={`人脸照片&身份证头像 相似度${
            this.state.compareData.likePercent
          }`}
          noHovering={true}
        >
              ...
              >
                <div>
                  <img
                    ...
                    height="170"
                    width="100%"
                    src={this.state.compareData.faceUrl}
                  />
                </div>
                <div>
                  <p>背景照</p>
              ...
              >
                <div>
                  <img
                    ...
                    height="170"
                    width="100%"
                    src={this.state.compareData.idAvatar}
                  />
                </div>
                <div>
                  <p>身份证头像</p>
              ...
              >
                <div>
                  <img
                    ...
                    height="170"
                    width="100%"
                    src={this.state.compareData.oneActionUrl}
                  />
                </div>
                <div>
                  <p>动作1</p>
              ...
              >
                <div>
                  <img
                    ...
                    height="170"
                    width="100%"
                    src={this.state.compareData.secondActionUrl}
                  />
                </div>
                <div>
                  <p>动作2</p>
              ...
              >
                <div>
                  <img
                    ...
                    height="170"
                    width="100%"
                    src={this.state.compareData.thirdActionUrl}
                  />
                </div>
                <div>
                  <p>动作3</p>
