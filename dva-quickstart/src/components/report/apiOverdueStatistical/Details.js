...
@connect(({ apiOverdueStatistical }) => ({
  list: apiOverdueStatistical.detailList
}))
export default class Details extends Component {
  ...
  handleFetch = () => {
    this.props.dispatch({
      type: "apiOverdueStatistical/fetchDetails",
      payload: { dataTime: getLocationSearch().dataTime, channelType: 1 }
    });
  };
  render() {
