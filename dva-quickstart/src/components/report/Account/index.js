      ...
      <Card bordered={false}>
        <Row style={{ marginBottom: 20 }}>
          <Col sm={6} xs={24} style={{ marginBottom: 20 }}>
            <Radio.Group value={this.state.radioValue} onChange={this.handleChangeRadio} buttonStyle="solid">
        ...
        {this.state.radioValue === 'into' ? <IntoList handleFetch={this.handleFetchInfo} /> : <OutList handleFetch={this.handleFetchOut} />}
      </Card>
    );
  }
}
